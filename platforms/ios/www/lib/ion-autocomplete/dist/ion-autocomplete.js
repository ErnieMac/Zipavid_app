        ...
        return {
            ...
            link: function (scope, element, attrs, controllers) {
                ...
                var template = [
                    ...
                    '<ion-item ng-if="viewModel.isArray(viewModel.selectedItems)" ng-repeat="selectedItem in viewModel.selectedItems track by $index" class="item-icon-left item-icon-left-padded item-icon-right item-text-wrap">',
